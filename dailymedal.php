...
$dailyMedalProducts = $conn->query("SELECT * FROM `gudu_products_details` WHERE `marketplace_id` = '$mp_id' ");
if($dailyMedalProducts) :
...
<html lang="en">
  ...
  <head>
    ...
    <title>Gudu Marketplace - Daily Medal</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light shadow-sm">
    <div class="container">
      ...
      <!-- links -->
      <div class="collapse navbar-collapse text-center align-content-center justify-content-center" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto py-3">
          <li class="nav-item">
            <a class="nav-link mx-2 active" aria-current="page" href="dailymedal.php?mpid=1&type=dm">Daily Medal</a>
          </li>
          <li class="nav-item">
        ...
        <li class="nav-item dropdown ms-auto">
          <a class="nav-link dropdown-toggle txt-custom username_link" href="javascript:void(0)" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <div class="container py-5 m-5">
    ...
    <div class="row py-5">
      <?php
        foreach( $dailyMedalProducts as $product) :
        ...
        <div class="product-grid">
          <div class="product-image">
            ...
            <ul class="product-links">
              <li><a href="javascript:void(0)" class="quick_view" data-id="<?=$productId?>" data-tip="Quick View"><i class="fa fa-search"></i></a></li>
            </ul>
          </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body py-4">
          <div class="row">
            <div class="col-md-4 product_img">
                <img id="pimg" src="" class="img-responsive ">
            </div>
            <div class="col-md-8 mt-1 product_content">
                <h6><span id="pname" class="fst-italic"></span> </h6>
                <p>Description: <span id="pdesc" ></span></p>
                <h6>Price: <span id="pcost" class="txt-custom"></span></h6>
          ...
          <input type="hidden" name="userfname" id="userfname" >
        ...
        <div class="d-flex align-items-center justify-content-center modal-footer">
            <button class="btn btn-outline-primary redeem-btn br-20">Redeem</button>
            <button id="close" data-bs-dismiss="modal" class="btn btn-danger m-2 br-20">Cancel</button>
        </div>
      </form>
      </div>
    </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      // now implemented in custom.js file
      var user_info = localStorage.getItem('guser');
      var rec =JSON.parse(user_info);

      // view product and redeem action button
      ...
      // redeemItem submit form function
      $('#redeemForm').submit(function(e) {
        e.preventDefault();
        var formData = new FormData(this);
        $('.redeem-btn').text('please wait...').attr('disabled', 'disabled');

        $.ajax({
          type: 'POST',
          url: apiUrl +'marketplace/redeem_product.php',
          data: formData,
          dataType: 'json',
          contentType: false,
          processData: false,
          success: function(res) {
            ...
            //   $('.redeem-btn').text('Redeem').attr('disabled', false);
